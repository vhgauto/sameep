...
<center style="font-size:.1em; align:center"><br></center>
...
<p style='color:grey;'>`r format(now(tzone = "America/Argentina/Buenos_Aires"), "%d/%m/%Y %T")`</p>

Ver en [<img src='extras/github.png' width='25'></img>](`r rmarkdown::metadata$github_repo`){target="_blank"}
