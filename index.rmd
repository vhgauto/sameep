...
g1 <- ggplot(data = t_p3, aes(x = fecha, y = .pred)) +
  ...
  geom_point_interactive(
    ...
    color = "#FC8D59", size = 2, alpha = .8, shape = 19, hover_nearest = TRUE) +
  # manual
  scale_x_continuous(
    breaks = seq.Date(fe1, fe2, "1 month"), labels = eje_x_fecha,
    expand = c(0, 0)) +
...
<p style='font-family: Ubuntu;'>Ver en [<span style='font-family: fa-brands; color: black'>&#xf09b;</span>](`r rmarkdown::metadata$github_repo`){target="_blank"}</p>
:::
